...
def generateOutputs(key, value, depth=4):
    ...
    return dirPath, leafPath, content
        ...
        with open(archive, 'rb') as f:
            ...
            while True:
                ...
                for cred in splitted:
                    ...
                    # Write
                    dirPath, leafPath, content = generateOutputs(username, password)
                    os.makedirs(outputDir + dirPath, exist_ok=True)
                    with open(outputDir + leafPath, 'wb') as outputFile:
